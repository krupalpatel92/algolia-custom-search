...
autocomplete('#tie-popup-search-input', {}, [
    {
      source: autocomplete.sources.hits(posts, { hitsPerPage: 5 }),
      displayKey: 'name',
      templates: {
        // ${hit.images.thumbnail.url}
        footer({query, isEmpty }) { if(!isEmpty) { return `<div class="widget-post-list"><a class="button fullwidth" href=/?s=${query}>View all results</a></div>`}},
        routing: true,
